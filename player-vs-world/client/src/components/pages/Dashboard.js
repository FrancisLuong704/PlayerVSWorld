...
const Dashboard = () => (
  ...
  <div className="uk-container page-container">
    ...
    <div className="cardRows">
      {/* friend card */}
      <div className="uk-width-1-3@s cardBody uk-grid-collapse uk-grid uk-margin-small-left">
        <div className="uk-card uk-card-transparent dashboardCards uk-card-default uk-card-hover uk-card-body">
      ...
      {/* group card */}
      <div className="uk-card uk-width-1-3@s cardBody uk-grid-collapse uk-grid uk-margin-small-left">
